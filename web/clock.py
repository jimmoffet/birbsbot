...
from services.v01.clock.mongoutils import clockTest, usajobs
...
try:
    ...
    sched.add_job(clockTest, CronTrigger.from_crontab(
        '0 20 * * 0-6', timezone='UTC'))
    sched.start()

except Exception as err:  # pylint: disable=broad-except
    log.error('Clock process failed with error: %s and traceback: %s',
